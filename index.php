                ...
                <div class="slider-item">
                    <div class="container">
                        <div class="slider-content">
                            <span class="sub-title">1 Year of Experience in web designing</span>
                            <h1>Digital web design solutions agency</h1>
                            <div class="slider-btns">
                                <a href="contact.php" class="theme-btn">Get Started Us <i class="fas fa-angle-double-right"></i></a>
                                <a href="services.php" class="theme-btn style-three">Explore Services <i class="fas fa-angle-double-right"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row row-cols-xl-6 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 justify-content-center">
                    <div class="col wow fadeInUp delay-0-2s">
                        <div class="feature-item-five">
                            ...
                            <h5><a href="services.php">Responsive design</a></h5>
                        </div>
                    </div>
                    <div class="col wow fadeInUp delay-0-3s">
                        <div class="feature-item-five">
                            <i class="flaticon-feature"></i>
                            <h5><a href="services.php">Powerful Customization</a></h5>
                        </div>
                    </div>
                    <div class="col wow fadeInUp delay-0-4s">
                        <div class="feature-item-five">
                            <i class="flaticon-aim"></i>
                            <h5><a href="services.php">Cool & modern animations</a></h5>
                        </div>
                    </div>
                    <div class="col wow fadeInUp delay-0-5s">
                        <div class="feature-item-five">
                            <i class="flaticon-seo"></i>
                            <h5><a href="services.php">SEO Friendly Coding</a></h5>
                        </div>
                    </div>
                    <div class="col wow fadeInUp delay-0-6s">
                        <div class="feature-item-five">
                            <i class="flaticon-search-location"></i>
                            <h5><a href="services.php">Best Technical supports</a></h5>
                        </div>
                    </div>
                    <div class="col wow fadeInUp delay-0-7s">
                        <div class="feature-item-five">
                            <i class="flaticon-settings"></i>
                            <h5><a href="services.php">Varied Layouts & parallax</a></h5>
                        </div>
                    </div>
                </div>
            </div>
                           ...
                           <div class="row">
                                <div class="col-lg-12 col-sm-6">
                                    <div class="service-item style-three wow fadeInRight delay-0-2s">
                                        ...
                                        <div class="content">
                                            <h4><a href="services.php">Website Creation from Scratch</a></h4>
                                            <a class="more-btn" href="services.php"><i class="fal fa-long-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-sm-6">
                                    <div class="service-item style-three wow fadeInRight delay-0-3s">
                                        ...
                                        <div class="content">
                                            <h4><a href="services.php">Website maintenance Services</a></h4>
                                            <a class="more-btn" href="services.php"><i class="fal fa-long-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="service-item style-three wow fadeInUp delay-0-3s">
                                        ...
                                        <div class="content">
                                            <h4><a href="services.php">eCommerce and product selling</a></h4>
                                            <a class="more-btn" href="services.php"><i class="fal fa-long-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="service-item style-three mt-30 wow fadeInUp delay-0-4s">
                                        ...
                                        <div class="content">
                                            <h4><a href="services.php">Responsive websites (UI/UX) design</a></h4>
                                            <a class="more-btn" href="services.php"><i class="fal fa-long-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                           ...
                           <div class="row">
                                <div class="col-lg-12 col-sm-6">
                                    <div class="service-item style-three mt-100 wow fadeInLeft delay-0-2s">
                                        ...
                                        <div class="content">
                                            <h4><a href="services.php">Search Engine Optimization</a></h4>
                                            <a class="more-btn" href="services.php"><i class="fal fa-long-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-sm-6">
                                    <div class="service-item style-three wow fadeInLeft delay-0-3s">
                                        ...
                                        <div class="content">
                                            <h4><a href="services.php">User Experience and Design</a></h4>
                                            <a class="more-btn" href="services.php"><i class="fal fa-long-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="project-three-active">
                <div class="project-item style-two wow fadeInUp delay-0-2s">
                    <div class="project-iamge">
                        <img src="assets/images/projects/project-three1.jpg" alt="Project">
                        <div class="project-over">
                            <a class="details-btn" href="projects.php"><i class="far fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="project-content">
                        <h4><a href="projects.php">Creative Website design</a></h4>
                        <span class="category">Design Responsive</span>
                    </div>
                </div>
                <div class="project-item style-two wow fadeInUp delay-0-4s">
                    <div class="project-iamge">
                        <img src="assets/images/projects/project-three2.jpg" alt="Project">
                        <div class="project-over">
                            <a class="details-btn" href="projects.php"><i class="far fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="project-content">
                        <h4><a href="projects.php">Software Landing Pages</a></h4>
                        <span class="category">Design Responsive</span>
                    </div>
                </div>
                <div class="project-item style-two wow fadeInUp delay-0-6s">
                    <div class="project-iamge">
                        <img src="assets/images/projects/project-three3.jpg" alt="Project">
                        <div class="project-over">
                            <a class="details-btn" href="projects.php"><i class="far fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="project-content">
                        <h4><a href="projects.php">Mobile Application Design</a></h4>
                        <span class="category">Design Responsive</span>
                    </div>
                </div>
                            ...
                            <div class="pricing-inner">
                                ...
                                <div class="price-and-btn">
                                    <div class="content">
                                        ...
                                        <a href="plan.php" class="theme-btn style-three">Choose Package <i class="fas fa-angle-double-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="contact-info-wrap">
                                ...
                                <div class="contact-info-item">
                                    ...
                                    <div class="content">
                                        ...
                                        <b class="text"><a href="callto:+919502531670">+ 91 9502531670</a></b>
                                    </div>
                                </div>
                            </div>
                       </div>
