                ...
                <div class="row align-items-end justify-content-between">
                    <div class="col-lg-7">
                        <div class="contact-content rmb-65 wow fadeInRight delay-0-2s">
                            ...
                            <form id="contactForm" class="contactForm z-1 rel"  action="includes/contact-form-handler.php" name="contactForm" method="post">
                                <div class="row pt-15">
                                    <div class="col-md-6">
                        ...
                        <div class="contact-info wow fadeInLeft delay-0-2s">
                            ...
                            <div class="contact-info-item style-two">
                                ...
                                <div class="content">
                                    ...
                                    <span class="text">
                                        Call : <a href="tel:+919502531670">+91-9502531670</a><br>
                                        Whatsapp : <a href="https://api.whatsapp.com/send?phone=919502531670" target="_blank">+91-9502531670</a>
                                    </span>
                                </div>
                            </div>
                            <div class="follow-us">
